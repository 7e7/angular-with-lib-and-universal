...
@Directive({
  selector: '[jbActionLink]',
  host: {
    class:
      'pointer h-100 dib copy-s b no-underline underline-hover hover-core-blue royal-blue',
    '[attr.aria-describedby]':
      "ariaDescribedBy || srText ? [ariaDescribedBy, srText ? srId : ''] : null",
  },
})
export class ActionLinkDirective implements AfterViewInit {
